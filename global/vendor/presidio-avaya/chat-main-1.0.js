...
*/
/* ---- File (1): _AVAYA_HTML_.html; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
var _AVAYA_HTML_ = 
'<!-- ' + 
...
/* ---- File (2): libs/xmlToJSON.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
...
/* ---- File (3): libs/AvayaClientServices.min.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
...
/* ---- File (4): avayaGlobal.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
...
/* ---- File (5): links.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (6): webChatConfig.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (7): webChatLogon.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (8): webChatUI.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (9): webChatSocket.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
var chatSocket = {
    ...
    setupRefresh: function(){
        ...
        avayaGlobal.setSessionStorage("users", JSON.stringify(users));
			...
			//MOBILETEST Start
			var params = {
				'event': 'after setup refresh',
				userAgent: navigator.userAgent,
				comment: 'message count: ' + messageCount,
				url: window.location.href,
			};
			var str = '';
			for(var i in params) str += i + '=' + encodeURI(params[i]) + '&';
    ...
    saveTranscript: function(){
		...
		var i = avayaGlobal.getSessionStorage('transcript_iterator');
		if(!i) i=0;
		i = parseInt(i);
		avayaGlobal.setSessionStorage('transcript_iterator', i+1);
		
			//MOBILETEST Start
			var params = {
				'event': 'saving transcript',
				userAgent: navigator.userAgent,
				comment: 'message count: ' + messages.length,
				url: window.location.href,
			};
			var str = '';
			for(var i in params) str += i + '=' + encodeURI(params[i]) + '&';
...
/* ---- File (10): estimatedWaitTime.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (11): webChat.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (12): oceanaCoreData.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
...
/* ---- File (13): customerJourneyCommon.js; compiled 2019-06-14 00:33:24 by /src/compile.php ---- */
/**
 *  Copyright 2018 Avaya Inc. All Rights Reserved.
 *
 * Usage of this source is bound to the terms described in
